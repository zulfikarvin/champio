    ...
    return (
      <main className="flex min-h-svh items-center justify-center px-5 py-12">
        <div className="card w-full max-w-sm p-6 sm:p-8">
          <h1 className="display-lg mb-1 text-primary">Set up your team</h1>
          <p className="mb-6 text-sm text-ink-muted">
            Everything in Champio — proposals, rubrics, diagnostics — belongs to a
            team. Create one to get started.
          </p>
          <CreateTeamForm />
